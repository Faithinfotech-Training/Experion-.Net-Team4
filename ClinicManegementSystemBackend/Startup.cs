...
namespace ClinicManegementSystemBackend
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ClinicManagementSystemContext>(
            ...
            services.AddScoped<IPrescribedTest, PrescribedTest>();
            services.AddScoped<ILogin, Login>();
            services.AddScoped<IAppointmentRepository, AppointmentRepository>();
            services.AddScoped<IDoctorNotesRepository, DoctorNotesRepository>();
            ...
            services.AddScoped<IUserViewModelRepo, UserViewModelRepo>();
