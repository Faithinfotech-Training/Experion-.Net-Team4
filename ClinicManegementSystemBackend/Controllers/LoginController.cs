...
namespace ClinicManegementSystemBackend.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        private TblUser AuthenticateUser(string userName, string password)
        {
            ...
            TblUser dbuser = _loginRepository.validateUser(userName, password);//checking validity of user by username and password
        ...
        public async Task<IActionResult> getUser(string userName, string password)
        {
            try
            {
                var dbuser =  _loginRepository.validateUser(userName, password);
                if (dbuser == null)
                {
                    return NotFound();
                }
